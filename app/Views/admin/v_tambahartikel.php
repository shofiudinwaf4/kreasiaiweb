     ...
     <div class="col-md-8">
         ...
         <div class="card card-primary">
             ...
             <?php session();
                ...
                ?>
             <form role="form" action="<?= base_url('artikel/save') ?>" method="post" enctype="multipart/form-data">
                 <div class="card-body">
                     <div class="form-group">
                         <label>Judul Artikel</label>
                         <input type="text" name="judul_artikel" class="form-control <?= ($validation->hasError('judul_artikel')) ? 'is-invalid' : ""; ?>" placeholder="Judul Artikel" autofocus>
                     ...
                     <div class="form-group">
                         ...
                         <textarea id="editor" name="deskripsi_artikel" class="form-control" placeholder="Deskripsi Artikel" cols="30" rows="5"><?= old('deskripsi_artikel'); ?></textarea>
                     </div>
                     <div class="form-group">
                         <label>Isi Artikel</label>
                         <textarea id="editor1" name="isi_artikel" class="form-control" placeholder="Isi Artikel" cols="30" rows="10"><?= old('isi_artikel'); ?></textarea>
                     </div>
