                    ...
                    <?php foreach ($paket_layanan as $key) : ?>
                        <tr>
                            ...
                            <td class="project-actions text-right">
                                ...
                                <a class="btn btn-danger btn-sm " href="<?= base_url("homeadmin/daftarpaket/" . $layanan['id_layanan'] . "/?aksi=hapus&id_paket=" . $key['id_paket']) ?>" onclick="return confirm('Yakin ingin menghapus data ini??')">
